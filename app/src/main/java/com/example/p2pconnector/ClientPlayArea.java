...
public class ClientPlayArea extends Fragment {

    public ClientPlayArea(MainActivity mainActivity) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_client_play_area, container, false);
        ImageView img_as_opponent = view.findViewById(R.id.img_host_as_opponent);
        ImageView img_self = view.findViewById(R.id.img_client_self);
        Button btn_roll = view.findViewById(R.id.btn_roll_client);
        Random random = new Random();
        //0:paper
        //1:rock
        //2:seisor

        //We will start a thread here which will listen to the inputs coming from host player.
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                while (true){
                    Log.d("resp_at_client",""+ MainActivity.client.getInputStreamManager().getResponseReceivedAtClient());
                    JSONObject obj = null;
                    try {
                        obj = new JSONObject(MainActivity.client.getInputStreamManager().getResponseReceivedAtClient());
            ...
            public void onClick(View v) {
                ...
                switch (value){
                    case 0:
                        ...
                        if(msg!=null){
                            MainActivity.client.getOutPutStreamManager().WriteFromClientToServer(new MessageFromClientToServer(msg));
